    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
        ...
        public virtual async Task<CustomerNavigationModel> PrepareCustomerNavigationModelAsync(int selectedTabId = 0)
        {
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                ...
                Tab = CustomerNavigation.Addresses,
                    ...
                    (await _workContext.GetCurrentCustomerAsync()).Id, pageIndex: 0, pageSize: 1)).Any())
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    ...
                    Tab = CustomerNavigation.ReturnRequests,
            ...
            if (!_customerSettings.HideDownloadableProductsTab)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    ...
                    Tab = CustomerNavigation.DownloadableProducts,
            ...
            if (!_customerSettings.HideBackInStockSubscriptionsTab)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    ...
                    Tab = CustomerNavigation.BackInStockSubscriptions,
            ...
            if (_rewardPointsSettings.Enabled)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    ...
                    Tab = CustomerNavigation.RewardPoints,
            ...
            model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
            {
                ...
                Tab = CustomerNavigation.ChangePassword,
            ...
            if (_catalogSettings.ShowProductReviewsTabOnAccountPage)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    ...
                    Tab = CustomerNavigation.ProductReviews,
            ...
            if (_vendorSettings.AllowVendorsToEditInfo && await _workContext.GetCurrentVendorAsync() != null)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    ...
                    Tab = CustomerNavigation.VendorInfo,
            ...
            if (_gdprSettings.GdprEnabled)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    ...
                    Tab = CustomerNavigation.GdprTools,
            ...
            if (_captchaSettings.Enabled && _customerSettings.AllowCustomersToCheckGiftCardBalance)
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    ...
                    Tab = CustomerNavigation.CheckGiftCardBalance,
            ...
            if (await _multiFactorAuthenticationPluginManager.HasActivePluginsAsync())
            {
                model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
                {
                    ...
                    Tab = CustomerNavigation.MultiFactorAuthentication,
                    ItemClass = "customer-multiFactor-authentication"
                });
            }

            model.SelectedTab = (CustomerNavigation)selectedTabId;
